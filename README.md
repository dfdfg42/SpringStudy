...
스프링 공부 기록 모음. 흩어져 있던 리포 5개를 하나로 모은 모노레포다.

- 폴더별로 독립 Gradle 프로젝트다. IntelliJ에서 폴더 단위로 연다.
- 커밋 히스토리를 그대로 가져왔다. `git log -- <폴더>` 또는 GitHub 폴더 History로 볼 수 있다.
- 통합 과정은 [docs/2026-09-16-spring-study-monorepo-design.md](docs/2026-09-16-spring-study-monorepo-design.md) 참고.
